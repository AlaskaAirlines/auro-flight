...
describe("auro-flight-main", () => {
  ...
  it("auro flight with no reroutes, and a single flight", async () => {
    ...
    const expectedArrival = "arrives P V D at 11:55 AM";

    const actual = el.shadowRoot
      .querySelector(".util_displayHiddenVisually")
      .textContent.trim()
      .replace(/\n|\r/g, "");
  ...
  it("non-stop that arrives next day", async () => {
    ...
    const expectedComposedArrival = "arrives P V D at 11:55 AM";
    const expectedNextDay = "next day";
    const expectedNonstop = "nonstop";
  ...
  it("non-stop that arrives two days later", async () => {
    ...
    const expectedDeparture = "Departs from S E A at 12:30 AM";
    const expectedArrival = "arrives P V D at 11:55 AM";
    const expectedComposition = "2 days later";
  ...
  it("auro flight with a departure reroute", async () => {
    ...
    const expectedDepartureTime = "12:30 AM";
    const expectedReroutedFlight = "Flight S E A to P V D has been re-routed.";
  ...
  it("flight with a stopover", async () => {
    ...
    const composedArrival = "arrives P V D at 11:55 AM";
    const composedStop = "with a stop in L A X";
  ...
  it("flight with a layover", async () => {
    ...
    const composedDeparture = "Departs from S E A at 12:30 AM,";
    const composedArrival = "arrives P V D at 11:55 AM";
    const composedLayover = "with a layover in S F O";
    const composedDuration = "for 1hr 42m";
  ...
  it("flight with a layover", async () => {
    ...
    `);
    const composedDeparture =
      "Departs from S E A at 12:30 AM, arrives P V D at 11:55 AM";
    const composedStop = "with a stop in L A X";
    const composedConnectorText = "and";
    const composedLayover = "with a layover in S F O";
    const composedDuration = "for 1hr 42m";
