...
| i18nArrival               | i18nArrival               |           |        |         | Localize arrival sentence. Template: `arrives {station} at {time}`                                                          |
| i18nCanceled              | i18nCanceled              |           |        |         | Localize canceled label. Default: `canceled`                                                                                |
| i18nDaysLater             | i18nDaysLater             |           |        |         | Localize multi-day label. Template: `{count} days later`                                                                    |
| i18nDeparture             | i18nDeparture             |           |        |         | Localize departure sentence. Template: `Departs from {station} at {time}`                                                   |
| i18nLastLayover           | i18nLastLayover           |           |        |         | Localize layover with duration (last). Template: `and with a layover in {station} for {duration}`                           |
| i18nLastLayoverNoDuration | i18nLastLayoverNoDuration |           |        |         | Localize layover without duration (last). Template: `and with a layover in {station}`                                       |
| i18nLastStopover          | i18nLastStopover          |           |        |         | Localize stop label (last). Template: `and with a stop in {station}`                                                        |
| i18nLayover               | i18nLayover               |           |        |         | Localize layover with duration (non-last). Template: `with a layover in {station} for {duration}`                           |
| i18nLayoverNoDuration     | i18nLayoverNoDuration     |           |        |         | Localize layover without duration (non-last). Template: `with a layover in {station}`                                       |
| i18nNextDay               | i18nNextDay               |           |        |         | Localize next-day label. Default: `next day`                                                                                |
| i18nNonstop               | i18nNonstop               |           |        |         | Localize nonstop label. Default: `nonstop`                                                                                  |
| i18nRerouteAnnouncement   | i18nRerouteAnnouncement   |           |        |         | Localize reroute opener. Template: `Flight {origin} to {destination} has been re-routed.`                                   |
| i18nReroutedArrival       | i18nReroutedArrival       |           |        |         | Localize rerouted arrival. Template: `and arrives {station} at {time}`                                                      |
| i18nReroutedDeparture     | i18nReroutedDeparture     |           |        |         | Localize rerouted departure. Template: `The flight now departs from {station} at {time}`                                    |
| i18nStopover              | i18nStopover              |           |        |         | Localize stop label (non-last). Template: `with a stop in {station}`                                                        |
