...
class AuroFlight extends i$3 {
  ...
  static get properties() {
    return {
      ...
      /**
       * Overrides the computed `aria-label` on the card entry announcement — bypasses all `i18n-*` attributes.
       * @attr {String} ariaLabel
       */
  ...
  render() {
    const label = this.ariaLabel ?? this._buildAriaLabel();
    return x`
