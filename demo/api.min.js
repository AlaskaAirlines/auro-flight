...
class AuroFlightline extends r {
  ...
  static register(name = "auro-flightline") {
    AuroLibraryRuntimeUtils$5.prototype.registerComponent(name, AuroFlightline);
  }
...
class AuroBadge extends r {
  ...
  static register(name = "auro-badge") {
    AuroLibraryRuntimeUtils$4.prototype.registerComponent(name, AuroBadge);
  }
...
class AuroFlightSegment extends r {
  ...
  static register(name = "auro-flight-segment") {
    AuroLibraryRuntimeUtils$5.prototype.registerComponent(name, AuroFlightSegment);
  }

  firstUpdated() {
    // Add the tag name as an attribute if it is different than the component name
    AuroLibraryRuntimeUtils$5.prototype.handleComponentTagRename(this, 'auro-flight-segment');
  }
...
class AuroFlight extends r {
  ...
  static register(name = "auro-flight") {
    AuroLibraryRuntimeUtils$6.prototype.registerComponent(name, AuroFlight);
  }
